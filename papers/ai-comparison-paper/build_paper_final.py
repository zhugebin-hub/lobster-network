#!/usr/bin/env python3
"""
按照浙江工商大学毕业论文模板格式生成小论文 Word 文档
参考模板：李皓然-室外远程驾驶无人车路径规划与避障系统设计_（最终版）.docx
"""
...
add_para('A Comparative Study of Mainstream Artificial Intelligence Systems:',
         'Times New Roman', Pt(14), True, WD_ALIGN_PARAGRAPH.CENTER,
...
add_para('——Functional Features, Application Scenarios and User Experience Analysis',
         'Times New Roman', Pt(14), False, WD_ALIGN_PARAGRAPH.CENTER,
...
# 2 主流人工智能系统概述
add_chapter_title('2 主流人工智能系统概述')

add_section_title('2.1 ChatGPT（OpenAI）')
...
add_section_title('2.2 Claude（Anthropic）')
...
add_section_title('2.3 通义千问（阿里巴巴）')
...
add_section_title('2.5 Kimi智能助手（月之暗面）')
...
# 3 多维度比较分析
add_chapter_title('3 多维度比较分析')

add_section_title('3.1 技术能力比较')

add_subsection_title('3.1.1 语言理解与生成能力')
...
add_subsection_title('3.1.2 逻辑推理与数学能力')
...
add_subsection_title('3.1.3 多模态能力')
...
add_section_title('3.2 应用场景比较')

add_subsection_title('3.2.1 学术研究与论文写作')
...
add_subsection_title('3.2.2 编程与技术开发')
...
add_subsection_title('3.2.3 日常办公与效率提升')
...
add_section_title('3.3 用户体验比较')

add_subsection_title('3.3.1 使用门槛')
...
add_subsection_title('3.3.2 交互体验')
...
add_subsection_title('3.3.3 安全性与可靠性')
...
# 4 典型使用场景案例分析
add_chapter_title('4 典型使用场景案例分析')

add_section_title('4.1 学术论文写作辅助')
...
# 5 存在的问题与挑战
add_chapter_title('5 存在的问题与挑战')

add_section_title('5.1 技术层面的问题')
...
add_section_title('5.3 中国AI发展的特殊挑战')
...
# 6 未来发展趋势
add_chapter_title('6 未来发展趋势')

add_section_title('6.1 技术发展趋势')
...
# 7 结论与建议
add_chapter_title('7 结论与建议')

add_section_title('7.1 研究结论')
