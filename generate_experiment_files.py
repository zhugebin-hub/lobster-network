...
def create_word_report():
    ...
    # 保存
    output_path = '/home/admin/.openclaw/workspace/实验报告_PPT生成对比实验_支中乐.docx'
...
def create_ppt():
    ...
    add_text_box(slide, Inches(1.5), Inches(5), Inches(10), Inches(0.5),
                 '实验人：支中乐    课程：数字人文与 AI 应用    日期：2026年6月15日', 16, PptxRGBColor(0x99, 0xAA, 0xBB), False, PP_ALIGN.LEFT)
    ...
    add_text_box(slide, Inches(1.5), Inches(5), Inches(10), Inches(0.5),
                 '实验人：支中乐    课程：数字人文与 AI 应用', 18, PptxRGBColor(0x99, 0xAA, 0xBB), False, PP_ALIGN.CENTER)
    ...
    # 保存
    output_path = '/home/admin/.openclaw/workspace/PPT_演示文稿_支中乐.pptx'
