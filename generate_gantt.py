...
# Set font to support Chinese characters (optional, using English only here)
plt.rcParams['font.family'] = 'DejaVu Sans'
plt.rcParams['figure.dpi'] = 150

# Task data extracted from logbook
# Format: (Task Name, Start Date, End Date, Priority/Phase)
tasks = [
...
# Save as PNG
output_path = '/home/admin/.openclaw/workspace/project-gantt-chart.png'
