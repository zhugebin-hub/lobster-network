#!/usr/bin/env python3
"""Manus 直播介绍 Word 文档 - 最终完整版（整合所有案例）"""
...
p = doc.add_paragraph()
r = p.add_run(
    '本次直播解读清华版《Manus智能体全攻略》，聚焦AI赋能高校教学的五大场景：'
    '课件智能生成（现场演示用Manus打造"小龙虾三部曲"精品课件）、'
    '教学视频制作（根据PPT逐页内容自动生成教学视频）、'
    '教学案例开发（烟草数据挖掘培训、16章网络课程动画、微信小程序等8个工程级案例）、'
    '论文协作写作（从选题到成稿全流程支持）、'
    '实验数据可视化（一键生成可发表图表）。'
)
r.font.size = Pt(12)
