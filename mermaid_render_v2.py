...
mmd_path = os.path.join(workspace, "esp32-flowchart-v2.mmd")
output_path = os.path.join(workspace, "esp32-flowchart-v2.png")
...
temp_html = os.path.join(workspace, "temp_flowchart_v2.html")
