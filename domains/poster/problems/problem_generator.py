...
POSTER_TRAINING_OUTLINE = {
    "phase1": {
        ...
        "weeks": 6,
        "topics": {
            "week1": ["色彩理论", "排版原则", "字体选择", "视觉层次", "色彩搭配", "字体排版"],
            "week2": ["构图基础", "黄金比例", "对称与平衡", "留白艺术", "对比原则", "重复原则"],
            "week3": ["图片处理", "滤镜应用", "图层混合", "蒙版技巧", "通道应用", "路径工具"],
            "week4": ["品牌一致性", "Logo设计", "VI系统", "第一阶段考核", "品牌策略", "品牌视觉"],
            "week5": ["设计软件基础", "Photoshop入门", "Illustrator入门", "InDesign入门", "Figma入门", "Canva入门"],
            "week6": ["设计理论", "设计史", "设计流派", "设计风格", "设计趋势", "阶段考核"]
        },
    ...
    "phase2": {
        ...
        "weeks": 8,
        "topics": {
            "week5": ["信息图表设计", "数据可视化", "图标设计", "插画基础", "图表设计", "数据故事"],
            "week6": ["动态海报", "GIF制作", "微交互动画", "视频封面", "动画原理", "动效设计"],
            "week7": ["社交媒体海报", "小红书配图", "朋友圈海报", "Banner设计", "短视频封面", "直播背景"],
            "week8": ["活动海报", "学术海报", "商业海报", "公益海报", "展览海报", "演出海报"],
            "week9": ["响应式设计", "多尺寸适配", "暗色模式", "无障碍设计", "跨平台设计", "自适应布局"],
            "week10": ["第二阶段综合考核", "综合练习", "实战项目", "作品展示", "同行评审", "导师反馈"],
            "week11": ["高级排版", "网格系统", "字体设计", "版面构成", "视觉流程", "信息架构"],
            "week12": ["色彩进阶", "色彩心理学", "色彩文化", "色彩品牌", "色彩趋势", "色彩创新"]
        },
    ...
    "phase3": {
        ...
        "weeks": 8,
        "topics": {
            "week11": ["AI辅助设计", "Midjourney提示词", "DALL-E应用", "Stable Diffusion", "AI设计伦理", "AI设计趋势"],
            "week12": ["设计思维", "用户调研", "A/B测试", "迭代优化", "用户画像", "用户旅程"],
            "week13": ["跨平台设计", "Web+Mobile+Print", "品牌延展", "设计系统", "设计令牌", "组件库"],
            "week14": ["高效工作流", "模板化生产", "批量生成", "自动化脚本", "CI/CD设计", "设计自动化"],
            "week15": ["设计评审", "同行反馈", "客户沟通", "作品展示", "设计演讲", "设计文档"],
            "week16": ["第三阶段综合考核", "综合测试", "实战项目", "作品合集", "职业准备", "阶段总结"],
            "week17": ["高级AI设计", "AI工作流", "AI协作", "AI创新", "AI伦理", "AI未来"],
            "week18": ["设计领导力", "设计管理", "设计战略", "设计创新", "设计教育", "设计未来"]
        },
        "problems_per_topic": 5,
        "total_problems": 150
    }
