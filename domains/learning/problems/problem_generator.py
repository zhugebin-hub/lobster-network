...
TRAINING_OUTLINE = {
    "go": {
        "phase1": {
            ...
            "weeks": 6,
            "topics": {
                "week1": ["气的概念", "吃子基础", "禁入点", "打吃", "提子规则", "禁着点"],
                "week2": ["连接与切断", "逃子", "双打吃", "征子", "门吃", "抱吃"],
                "week3": ["扑与倒扑", "枷吃", "接不归", "倒脱靴", "胀死牛", "倒扑"],
                "week4": ["两眼活棋", "基本死活", "劫的概念", "缓气劫", "紧气劫", "第一阶段考核"],
                "week5": ["吃子技巧综合", "连接技巧", "切断技巧", "逃子技巧", "对杀基础", "双活基础"],
                "week6": ["死活综合练习", "手筋基础", "官子入门", "布局入门", "实战入门", "阶段考核"]
            },
        ...
        "phase2": {
            ...
            "weeks": 10,
            "topics": {
                "week5": ["小目定式·一间高挂", "小目定式·二间高挂", "星位定式", "三三定式", "目外定式", "高目定式"],
                "week6": ["定式选择原则", "定式后续变化", "定式与布局配合", "定式常见错误", "定式变着", "定式陷阱"],
                "week7": ["挂角方式", "夹击手法", "拆边原则", "根据地", "尖冲", "浅消"],
                "week8": ["布局基础·三连星", "布局基础·中国流", "布局基础·小林流", "布局中盘过渡", "平行布局", "对角布局"],
                "week9": ["中盘战斗基础", "攻防要点", "厚薄判断", "形势判断基础", "打入技巧", "治孤技巧"],
                "week10": ["手筋基础·吃子手筋", "手筋基础·连接手筋", "手筋基础·死活手筋", "手筋综合应用", "对杀手筋", "官子手筋"],
                "week11": ["官子基础·大小计算", "官子基础·先手官子", "官子基础·后手官子", "官子综合练习", "逆收官子", "双方先手官子"],
                "week12": ["实战对局分析", "名局研究", "复盘技巧", "第二阶段综合考核", "综合练习", "阶段测试"],
                "week13": ["中盘战术综合", "攻防转换", "模样与实地", "厚薄运用", "全局观", "战术选择"],
                "week14": ["定式综合应用", "布局综合", "中盘综合", "官子综合", "实战综合", "阶段考核"]
            },
        ...
        "phase3": {
            ...
            "weeks": 10,
            "topics": {
                "week13": ["复杂定式变化", "新型定式研究", "定式选择策略", "定式陷阱识别", "定式创新", "定式综合"],
                "week14": ["布局理论深化", "全局配合", "模样作战", "实地与外势", "布局创新", "布局综合"],
                "week15": ["中盘战术·攻击", "中盘战术·防守", "中盘战术·转换", "中盘战术·治孤", "中盘综合", "战术创新"],
                "week16": ["死活进阶·大龙生死", "死活进阶·对杀", "死活进阶·双活", "死活综合难题", "死活创新", "死活综合"],
                "week17": ["官子进阶·微妙官子", "官子进阶·逆收", "官子进阶·劫争官子", "官子精确计算", "官子综合", "官子创新"],
                "week18": ["复盘分析方法", "AI复盘应用", "名局研究", "个人棋风分析", "复盘综合", "复盘创新"],
                "week19": ["比赛策略", "时间管理", "心理调适", "实战模拟", "比赛综合", "心理综合"],
                "week20": ["第三阶段综合考核", "综合测试", "实战考核", "理论考核", "综合评定", "阶段总结"],
                "week21": ["高级战术", "创新布局", "高级死活", "高级官子", "高级中盘", "高级综合"],
                "week22": ["大师级定式", "大师级布局", "大师级中盘", "大师级官子", "大师级实战", "大师级考核"]
            },
            "problems_per_topic": 5,
            "total_problems": 180
        }
