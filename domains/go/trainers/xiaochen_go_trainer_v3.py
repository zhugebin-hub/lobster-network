...
# 稳健型参数
ACCURACY_BASELINE = {
    "入门": 0.90, "初级": 0.80, "中级": 0.70, "高级": 0.35
}
...
def solve_problem(problem):
    ...
    if ptype in ["死活", "手筋", "官子"]:
        ...
        thinking_time = random.randint(60, 300)
...
def process_training_task(task_data):
    ...
    problem_count = task.get("problem_count", 5)
...
def process_review_instruction(instruction):
    ...
    review = {
        ...
        "lessons_learned": ["中盘战斗要注意对方的断点", "官子阶段要计算精确"],
        "self_rating": random.randint(5, 8),
    }
...
def main():
    ...
    state["script_version"] = "V3-steady"
    save_state(state)
