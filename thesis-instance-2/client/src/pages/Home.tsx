...
// 操作手册PDF下载链接
const USER_MANUAL_URL = prefixPath("/files/templates/user-manual.pdf");
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            {language === "zh" ? "人工智能学院毕业设计管理系统" : "AI College Graduation Design Management System"}
          </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col items-center mb-8 pb-8 border-b border-gray-700">
            ...
            <a
              ...
              download={language === "zh" ? "人工智能学院毕业设计管理系统操作手册.pdf" : "User_Manual.pdf"}
