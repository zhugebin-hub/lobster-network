...
![钉钉 AI 助理生成成品](dingtalk-generated.png)
...
|--------|---------|-------------|
| **构图** | 人物站在路灯下，左侧枯木夜色，右侧暖黄木屋 | 人物站在路灯下，背景是小木屋 |
| **人物姿态** | 捧热饮，侧身站立 | 捧热饮，侧身站立 |
| **细节** | 呼出白气，小径脚印，积雪层次 | 呼出白气，小径脚印，窗户暖光 |
...
这说明**两个 AI 对同一 Prompt 的理解方向是一致的**。
...
1. **两个工具都能理解 Prompt 中的"矛盾情绪"，生成相似构图的画面**
2. **Manus AI 在细节处理、氛围营造等方面略优于钉钉 AI 助理**
